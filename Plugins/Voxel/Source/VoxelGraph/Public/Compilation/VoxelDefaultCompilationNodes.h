...
class FVoxelStaticClampCompilationNode : public TVoxelCompilationNode<EVoxelCompilationNodeType::StaticClamp, FVoxelStaticClampCompilationNode>
{
public:
	using TVoxelCompilationNode::TVoxelCompilationNode;

	virtual FString GetClassName() const override { return "StaticClamp"; }
};
