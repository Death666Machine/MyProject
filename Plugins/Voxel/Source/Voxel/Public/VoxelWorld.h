...
public:
	...
	FVoxelInstancedMeshManager* GetInstancedMeshManager() const { return InstancedMeshManager.Get(); }
	FVoxelSpawnerManager* GetSpawnerManager() const { return SpawnerManager.Get(); }
...
private:
	...
	TVoxelSharedPtr<FVoxelSpawnerManager> SpawnerManager;
...
private:
	...
	TVoxelSharedRef<FVoxelSpawnerManager> CreateSpawnerManager() const;
