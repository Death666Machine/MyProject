...
public:
	...
	virtual bool ReceiveSave(FVoxelCompressedWorldSave& OutSave) override final;
...
public:
	...
	virtual void SendSave(FVoxelCompressedWorldSave& Save, bool bForceLoad) override final;
