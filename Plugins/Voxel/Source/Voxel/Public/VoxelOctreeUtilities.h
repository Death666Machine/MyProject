...
namespace FVoxelOctreeUtilities
{
	...
	template<typename T, typename F1>
	inline void IterateTreeInBounds(T& Tree, const FIntBox& Bounds, F1 Apply)
	{
	...
	template<typename T, typename F1>
	inline bool IterateTreeInBoundsEarlyExit(T& Tree, const FIntBox& Bounds, F1 Apply)
	{
		bool bContinue = true;
		IterateTreeByPred(
			Tree,
	...
	template<typename T, typename F1>
	inline void IterateLeavesInBounds(T& Tree, const FIntBox& Bounds, F1 Apply)
	{
	...
	// To exit, return false in Apply
	template<typename T, typename F1>
	inline bool IterateLeavesInBoundsEarlyExit(T& Tree, const FIntBox& Bounds, F1 Apply)
	{
		bool bContinue = true;
		IterateLeavesByPred(
			Tree,
	...
	inline TOptional<U> ReduceInBounds(T& Tree, const FIntBox& Bounds, F1 Apply, F2 Reduction)
	{
