...
bool FVoxelMultiplayerClientWithSocket::ReceiveSave(FVoxelCompressedWorldSave& OutSave)
{
	VOXEL_FUNCTION_COUNTER();
...
void FVoxelMultiplayerServerWithSocket::SendSave(FVoxelCompressedWorldSave& Save, bool bForceLoad)
{
	VOXEL_FUNCTION_COUNTER();
