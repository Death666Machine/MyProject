...
private:
	FShaderResourceParameter RainMap;
	FShaderResourceParameter TerrainHeight;
	FShaderResourceParameter TerrainHeight1;
	FShaderResourceParameter WaterHeight;
	FShaderResourceParameter WaterHeight1;
	FShaderResourceParameter WaterHeight2;
	FShaderResourceParameter Sediment;
	FShaderResourceParameter Sediment1;
	FShaderResourceParameter Outflow;
	FShaderResourceParameter Velocity;
};
